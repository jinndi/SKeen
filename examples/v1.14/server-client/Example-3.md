...
Подробнее смотрите в файле [Server-sing-box.md](../server-client/Server-sing-box.md), тут только чистые шаблоны с фейковыми данными.
...
Что должны получить в итоге:
 ...
 5. Опционально: Сайт в Cloudflare на Workers & Pages с правилами в Workers Routes для `https://mydomain.com/*`
    и суб. `https://okko.mydomain.com/`, ..., ..., доменов на ваш воркер с сайтом .
